...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                ...
                final String path = bundle.getString(DownloadUtils.PATHNAME_KEY);

                outerClass.get().runOnUiThread(new Runnable() {
                    public void run() {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            Intent i = DownloadIntentService.makeIntent(getApplicationContext(), handler, url);
            startService(i);
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
            url = getUrlString();
            Intent intent = ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler,url);
            startService(intent);
